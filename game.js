...
function preload() {
    ...
    scene.load.image('Explosion1','./assets/img/boom.png');
    scene.load.image('Explosion2','./assets/img/bb.png');
    scene.load.image('bullet','./assets/img/bullet.png');
...
function createPlayer() {
    player = scene.physics.add.sprite(config.width/2, config.height/2, 'superhero');
    player.speed = 400;
    player.setScale(0.3);
